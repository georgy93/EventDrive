...
#line hidden
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "Integration", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        [Xunit.TraitAttribute("Description", "When I send a list of items to the WEB API and then send a synchronization reques" +
            "t, the items should be found in the data store")]
        public void WhenISendAListOfItemsToTheWEBAPIAndThenSendASynchronizationRequestTheItemsShouldBeFoundInTheDataStore()
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("When I send a list of items to the WEB API and then send a synchronization reques" +
                    "t, the items should be found in the data store", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 3
